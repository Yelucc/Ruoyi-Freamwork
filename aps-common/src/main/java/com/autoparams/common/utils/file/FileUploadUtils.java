package com.autoparams.common.utils.file;


import com.autoparams.common.config.MinioConfig;
import com.autoparams.common.config.RuoYiConfig;
import com.autoparams.common.constant.Constants;
import com.autoparams.common.exception.file.FileNameLengthLimitExceededException;
import com.autoparams.common.exception.file.FileSizeLimitExceededException;
...
import com.autoparams.common.utils.uuid.Seq;
import lombok.Data;
...
public class FileUploadUtils {
     ...
     * @throws Exception
     */
    public static final String upload(MultipartFile file, FileOss type) throws IOException {
        switch (type) {
            case MINIO:
                return uploadMinio(file);
            case NGINX:
            case SELF:
            default:
                return upload(file);
